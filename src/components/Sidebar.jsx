...
function Sidebar() {
  const menuItems = [
    ...
    { icon: 'https://cdn.builder.io/api/v1/image/assets/TEMP/b6df197e4965dbbe29017c22ea6d6f5f5412da579cc72a0a6dd74aa973b289eb?placeholderIfAbsent=true&apiKey=ec4f7db0a41840d7ad765c9cf4dfdec4', text: 'คำถามจากผู้ใช้', to: '/questions', active: true },
    ...
    { icon: 'https://cdn.builder.io/api/v1/image/assets/TEMP/bcc21451c0815821f0c99f309467129b86ba2741ce551b67ee0cd8064728e04b?placeholderIfAbsent=true&apiKey=ec4f7db0a41840d7ad765c9cf4dfdec4', text: 'จัดการผู้ใช้งาน', to: '/user-management', active: false },
  ];
  ...
  return (
    <nav className={styles.sidebar}>
      ...
      {menuItems.map((item, index) => (
        <Link key={index} to={item.to} className={`${styles.menuItem} ${item.active ? styles.activeMenuItem : ''}`}>
